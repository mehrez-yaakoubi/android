...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            // c'est le menu qui contient le repas a gauche
            case R.id.Meal:
            ...
            case R.id.Mycalorie:
                ...
                break;
// menu qui contient le food
            case R.id.Food:
                Intent food=new Intent(Home.this,FoodDay.class);
                startActivity(food);
                break;
                // c'est le menu qui contient les emplois de temps de l'entrainnement de chaque jour
            case R.id.schedule:
